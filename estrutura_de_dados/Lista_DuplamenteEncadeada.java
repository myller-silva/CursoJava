class Main{
  ...
  public static String multiplicar(String num1, String num2) {
    ...
    Lista_DuplamenteEncadeada parcelas = new Lista_DuplamenteEncadeada();
    Node no1 = l1.fim;
    Node no2 = l2.fim;
    int cont1=0;
    int cont2=0;
  ...
  private static String somatorio(Lista_DuplamenteEncadeada lista) {
  ...
  public static Lista_DuplamenteEncadeada separar(String str) {
